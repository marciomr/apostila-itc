...
O diagrama acima é uma abreviação para o seguinte diagrama:
  ...
  \begin{center}
    \begin{tikzpicture}[node distance=2cm,auto,>=latex, every node/.style={sloped}]
      ...
      \path[->] (qI) edge node{\small $\varepsilon$, $S \to 1$} (q2);
      \path[->] (q2) edge node[below]{\small $\varepsilon$, $\varepsilon \to S$} (q3);
      \path[->] (q3) edge node{\small $\varepsilon$, $\varepsilon \to 0$} (qI);
      \path[->] (qI) edge node {\small $\varepsilon$, $\$ \to \varepsilon$} (qF);
      \path[->] (qI) edge node {\small $\varepsilon$, $\$ \to \varepsilon$} (qF);
    \end{tikzpicture}
  \end{center}
...
\begin{example}
  ...
  \begin{center}
    \begin{tikzpicture}[node distance=2cm,auto,>=latex, every node/.style={sloped}]
      ...
      \path[->] (q0) edge node {\small $\varepsilon$, $\varepsilon \to \$$} (q1);
      \path[->] (q1) edge node {\small $\varepsilon$, $\varepsilon \to S$} (qI);
      \path[->] (qI) edge node{\small $\varepsilon$, $S \to b$} (q2);
      \path[->] (q2) edge node[below]{\small $\varepsilon$, $\varepsilon \to T$} (q3);
      \path[->] (q3) edge node{\small $\varepsilon$, $\varepsilon \to a$} (qI);
      \path[->] (qI) edge node {\small $\varepsilon$, $\$ \to \varepsilon$} (qF);
      \path[->] (qI) edge node {\small $\varepsilon$, $\$ \to \varepsilon$} (qF);
      \path[->, bend left = 40] (qI) edge node[below] {$\varepsilon, T \to a$} (q4);
      \path[->, bend left = 40] (q4) edge node {$\varepsilon, \varepsilon \to T$} (qI);
    \end{tikzpicture}
  \end{center}
...
Novamente usaremos a construção do teorema para construir um autômato de pilha que reconhece a mesma linguagem que essa gramática:
  ...
  \begin{center}
    \begin{tikzpicture}[node distance=2cm,auto,>=latex,every node/.style={sloped}]
      ...
      \path[->] (q0) edge node {\small $\varepsilon$, $\varepsilon \to \$$} (q1);
      \path[->] (q1) edge node {\small $\varepsilon$, $\varepsilon \to S$} (qI);
      \path[->] (qI) edge node{\small $\varepsilon$, $S \to )$} (q2);
      \path[->] (q2) edge node[below]{\small $\varepsilon$, $\varepsilon \to S$} (q3);
      \path[->] (q3) edge node{\small $\varepsilon$, $\varepsilon \to ($} (qI);
      \path[->] (qI) edge node {\small $\varepsilon$, $\$ \to \varepsilon$} (qF);
      \path[->] (qI) edge node {\small $\varepsilon$, $\$ \to \varepsilon$} (qF);
      \path[->, bend left = 40] (qI) edge node[below] {$\varepsilon, S \to S$} (q4);
      \path[->, bend left = 40] (q4) edge node {$\varepsilon, \varepsilon \to S$} (qI);
    \end{tikzpicture}
  \end{center}
\end{example}
...
Uma transição de $q_f'$ para si mesmo que não le nada e desempilha $s$ para cada $s \in \Gamma$ e uma transição que não lê nada e não mexe na pilha que vai de $q_f'$ para $q_f$.
  ...
  \end{center}
   ...
   \begin{center}
         \begin{tikzpicture}[node distance=2cm,auto,>=latex,every node/.style={sloped},initial text=]
      \tikzset{
        coil/.style={ decorate, decoration={ snake=coil} },
      }
      \node[state, initial, color=blue] (1) {$q_1$};
      \node[state, minimum size=0pt, color=blue] (2) at (3,1.5){};
      \node[state, minimum size=0pt, color=blue] (3) at (3,0){};
      \node[state, minimum size=0pt, color=blue] (4) at (3,-1.5){};
...
\begin{center}
    \begin{tikzpicture}[node distance=2cm,auto,>=latex,initial text=]
      ...
      \path[->] (qk) edge node {$\varepsilon, \varepsilon \to s_2$} (qj);
    \end{tikzpicture}
  \end{center}
\end{proof}
...
\begin{example}
    ...
    \begin{tikzpicture}[node distance=2cm,auto,>=latex,initial text=]
      ...
      \node[state, accepting] (f) at (0,-2){$q_f$};
...
\begin{proof}
 ...
 \begin{center}
    \begin{tikzpicture}
      ...
      \node (R1) at (0,-1) {$T$};
      \node (R2) at (0,-2) {$T$};
      \draw (S) to[bend right] (-3,-3);
      \draw (S) to[bend left] (3,-3);
      \draw (R1) to[bend right] (-2,-3);
      \draw (R1) to[bend left] (2,-3);
      \draw (R2) to[bend right] (-1,-3);
      \draw (R2) to[bend left] (1,-3);
      \draw[dotted] (S) to (R1);
      \draw[dotted] (R1) to (R2);
      \draw[|-|] (-3,-3) to node[below]{$u$} (-2,-3);
      \draw[|-|] (-2,-3) to node[below]{$v$} (-1,-3);
      \draw[|-|] (-1,-3) to node[below]{$x$} (1,-3);
      \draw[|-|] (1,-3)  to node[below]{$y$} (2,-3);
      \draw[|-|] (2,-3)  to node[below]{$z$} (3,-3);
    \end{tikzpicture}
  \end{center}
...
Note que $S \Rightarrow^* uxz$ se substituirmos a penúltima ocorrência de $T$ pela última (i.e. $S \Rightarrow^* uTz \Rightarrow^* uxz$).
 ...
 \begin{center}
    \begin{tikzpicture}
      \node (S) {$S$};
      \node (R) at (0,-1) {$T$};
      \draw (S) to[bend right] (-2,-3);
      \draw (S) to[bend left] (2,-3);
      \draw (R) to[bend right] (-1,-2);
      \draw (R) to[bend left] (1,-2);
      \draw[dotted] (S) to (R);
      \draw[dotted] (-1,-2) to (-1,-3);
      \draw[dotted] (1,-2) to (1,-3);
      \draw[|-|] (-2,-3) to node[below]{$u$} (-1,-3);
      \draw[|-|] (-1,-2) to node[below]{$x$} (1,-2);
      \draw[|-|] (1,-3) to node[below]{$z$} (2,-3);
    \end{tikzpicture}
  \end{center}
...
Da mesma forma, $S \Rightarrow^* uv^ixy^iz$ para qualquer $i > 1$ bastando repetir $i$ vezes a última ocorrência de $T$ pela penúltima.
 ...
 \begin{center}
    \begin{tikzpicture}
      ...
      \node (R2) at (0,-2) {$T$};
      \node (R3) at (0,-3) {$T$};
      \draw (S) to[bend right] (-4,-3);
      \draw (S) to[bend left] (4,-3);
      \draw (R1) to[bend right] (-3,-3);
      \draw (R1) to[bend left] (3,-3);
      \draw (R2) to[bend right] (-2,-4);
      \draw (R2) to[bend left] (2,-4);
      \draw (R3) to[bend right] (-1,-4);
      \draw (R3) to[bend left] (1,-4);
      \draw[dotted] (S) to (R1);
      \draw[dotted] (R1) to (R2);
      \draw[dotted] (R2) to (R3);
      \draw[dotted] (-2,-3) to (-2,-4);
      \draw[dotted] (2,-3) to (2,-4);
      \draw[|-|] (-4,-3) to node[below]{$u$} (-3,-3);
      \draw[|-|] (-3,-3) to node[below]{$v$} (-2,-3);
      \draw[|-|] (-2,-4) to node[below]{$v$} (-1,-4);
      \draw[|-|] (-1,-4) to node[below]{$x$} (1,-4);
      \draw[|-|] (1,-4)  to node[below]{$y$} (2,-4);
      \draw[|-|] (2,-3)  to node[below]{$y$} (3,-3);
      \draw[|-|] (3,-3)  to node[below]{$z$} (4,-3);
    \end{tikzpicture}
  \end{center}
